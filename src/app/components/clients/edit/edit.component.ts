...
@Component({
  ...
  template: `
    <form [formGroup]="clientForm" (ngSubmit)="onSubmit()" class="max-w-md mx-auto p-4 bg-off-white rounded-lg shadow-md my-10">
      <h1 class="text-2xl font-bold mb-4 text-dark-gray">Editar Cliente</h1>
      <div class="mb-4">
      ...
      <div class="flex justify-between">
        <button type="submit" [disabled]="clientForm.invalid" class="button-base button-primary w-full sm:w-auto mr-2">Actualizar</button>
